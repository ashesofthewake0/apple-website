// Videos
export const heroVideo = "/assets/videos/hightlight-sec.mp4";
export const smallHeroVideo = "/assets/videos/frame.mp4";
export const highlightFirstVideo = "/assets/videos/hightlight-sec.mp4";
